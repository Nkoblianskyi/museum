...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "CQ21WW9U3ehzwXZOKITe";
        $headers['auth']['clientSecret'] = "MzAyNENRMjFXVzlVM2VoendYWk9LSVRlY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
